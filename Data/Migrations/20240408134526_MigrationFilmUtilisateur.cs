    ...
    public partial class MigrationFilmUtilisateur : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmUtilisateur", x => new { x.IdUtilisateur, x.IdFilm });
                    table.ForeignKey(
                        name: "FK_FilmUtilisateur_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmUtilisateur_Film_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Film",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmUtilisateur_FilmId",
                table: "FilmUtilisateur",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_FilmUtilisateur_UserId",
                table: "FilmUtilisateur",
                column: "UserId");
        }
